...
class SymbolTable:
    ...
    def update(self):
        ...
        elif(self.semantictype == TokenType.NUMBER.value) or (self.semantictype == TokenType.STRING.value):
             self.semantictype = SemanticType.stconstant.name
             
             if(self.semantictype == TokenType.NUMBER.value): self.datatype = DataType.dtinteger.name
             else: self.datatype = DataType.dtstring.name

        elif(self.semantictype == TokenType.ID.value):
        ...
        elif(self.semantictype == TokenType.EOF.value) or (self.semantictype == TokenType.NEWLINE.value):
